#Bingo von https://github.com/ArminiusKratiphilus
def imports():
...
if __name__ == "__main__":
    ...
    gui = tk.Tk()
    gui.title("BINGO von https://github.com/ArminiusKratiphilus")
    ...
    reset_button = ttk.Button(control_panel, text="Neues Spiel", padding=3, command=reset)
